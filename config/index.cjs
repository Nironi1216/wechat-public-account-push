  ...
  USERS: [
    {
      ...
      id: 'o3uHH6Omja_xTkkLYfyZEl-06kTE',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'N6EW7Q6HJrFOQ_CNeG6Q1oyABtvuomN_MIPtZHPNOFw',
      // 所在省份
      province: '安徽',
      // 所在城市
      city: '合肥',
      ...
      openUrl: 'https://nironi.online',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '杨杨', year: '1999', date: '07-23',
        },
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'o3uHH6IxyPrm6xIDpbtcpXpsX2kM',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
